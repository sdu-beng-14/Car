...
int main(void) {
    ...
    // Variables for the second set of inputs
    int time2 = 0;
    float distance2 = 0;
    ...
    while (1) {
        ...
        // Execute second set immediately after the first finishes
        motor(distance2, time2);

        // Display battery voltage after completion
